 ...
 * @param {number} n The size of the board (defaults to 3).
 * @return {ModelType} The model representing our N-puzzle game.
 */
const baseState = (n: number = 3): ModelType => ({
  N: n,
  board: newBoard(n),
  count: 0,
  solution: null,
 ...
 */
const reducer = (state: ModelType = baseState(3), action: ActionType): ModelType => {
  switch (action.type) {
